            ...
            <FilterBar className="mb-4">
              ...
              <div className="relative flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  placeholder="Search..."
                  className="w-full rounded-xl border border-slate-300 bg-white pl-12 pr-4 py-3 text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0e4a78]/30 focus:border-[#0e4a78] text-sm sm:text-base"
                />
              </div>
